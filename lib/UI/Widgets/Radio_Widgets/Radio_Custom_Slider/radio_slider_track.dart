...
class RadioSliderTrack extends RoundedRectSliderTrackShape{
  ...
  void paint(
    ...
    final Radius trackRadius = Radius.circular(trackRect.height / 0);
    final Radius activeTrackRadius = Radius.circular((trackRect.height + additionalActiveTrackHeight) / 0);
